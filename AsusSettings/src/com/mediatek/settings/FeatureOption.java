...
public class FeatureOption {
    ...
    // sunhuihui@wind-mobi.com modify begin Feature#110139 2016/6/27
    public static final boolean WIND_DEF_ASUS_USB_DIALOG = getValue("ro.wind.def.asus_usb_dialog");
    // sunhuihui@wind-mobi.com modify end Feature#110139 2016/6/27

    //zhangyanbin@wind-mobi.com 2016.05.25 add for ASUS FOTA begin
    public static final boolean WIND_ASUS_FOTA = getValue("ro.wind_asus_fota");
    //zhangyanbin@wind-mobi.com 2016.05.25 add for ASUS FOTA end

    // M: cenxingcan@wind-mobi.com 2016.07.17 add for ASUS CELL BROADCAST begin
    public static final boolean WIND_DEF_ASUS_CELLBROADCAST = getValue("ro.wind.def.asuscellbroadcast");
    // M: cenxingcan@wind-mobi.com 2016.07.17 add for ASUS CELL BROADCAST end
