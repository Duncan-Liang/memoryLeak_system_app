...
public class AsusCoverSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (isSnapView()) {
            removePreference(KEY_TRANSCOVER_AUTOMATIC_UNLOCK);
            mTranscoverAutomaticUnlockCB = null;
        } else {
    ...
    private boolean isSnapView() {
        try {
            ...
            if (user == null) {
                ...
                boolean result = user.isSnapView();
    ...
    protected static int getCoverVersion(Context context) {
        ...
        if (!hasTranscoverFeature && !hasTranscoverInfoFeature) {
