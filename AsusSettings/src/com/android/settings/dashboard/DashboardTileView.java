...
public class DashboardTileView extends FrameLayout implements View.OnClickListener {
    ...
    private Switch mSwitch; //++Sunny_Yuan
    ...
    public DashboardTileView(Context context, AttributeSet attrs) {
        ...
        //++Sunny_Yuan
        final View view = LayoutInflater.from(context).inflate(R.layout.dashboard_tile_switch, this);
        ...
        //Ken1_Yu, TT- 506298 Asus customized settings
        if (mTitleTextView != null) {
            Utils.makeTextViewMarquee(mTitleTextView);
        }
