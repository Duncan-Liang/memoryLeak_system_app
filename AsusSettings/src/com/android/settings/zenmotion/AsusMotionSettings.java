...
,OnPreferenceChangeListener, SwitchBar.OnSwitchChangeListener, Indexable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // pengfugen@wind-mobi.com 2016/05/11 start
        if(WIND_DEF_RM_ZENMOTION_HANDUP) {
            removePreference(KEY_HAND_UP);
        }
        // pengfugen@wind-mobi.com 2016/05/11 end
        // Double click
        ...
        // Walking
        // xuyi@wind-mobi.com 20160712 modify for remvoe Moving function begin
        /*
        if (getPackageManager().hasSystemFeature(
        ...
        removePreference(KEY_WALKING);
        // xuyi@wind-mobi.com 20160712 modify for remvoe Moving function end
