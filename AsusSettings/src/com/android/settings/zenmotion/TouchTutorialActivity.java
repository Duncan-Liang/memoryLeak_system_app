...
public class TouchTutorialActivity extends FragmentActivity implements OnPageChangeListener{
    ...
    // wangyan@wind-mobi.com modify 2016/07/19 Feature #110195 start
    static enum Pagination {
        ...
        THIRD(R.string.doubletap_on_setting_title,
                R.string.swipe_up_to_wake_up_title,
        ...
        NINETH(R.string.v_launch_title,
    ...
    // wangyan@wind-mobi.com modify 2016/07/19 Feature #110195 end
    ...
    private void initViews() {
        ...
        final boolean isSupportSwipeTap = getPackageManager().hasSystemFeature(
