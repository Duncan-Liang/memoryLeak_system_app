...
public class FingerprintEnrollEnrolling extends FingerprintEnrollBase
    ...
    private static final double DESCRIPTION_UPDATE_RATIO2 = 0.7;
    private boolean mAlreadyShowHint = false;
    private int mLastRemaingCount = 0;
    //add by sunxiaolong@wind-mobi.com for asus's printfinger patch end
    ...
    //lizusheng@wind-mobi.com 20160512 start
    @Override
    public void onPause() {
        super.onPause();
        finish();
    }
    //lizusheng@wind-mobi.com 20160512 end
