    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        private RemovalCallback mRemovalCallback = new RemovalCallback() {
            ...
            public void onRemovalSucceeded(Fingerprint fingerprint) {
                ...
                //modified by lizusheng@wind-mobi.com 20160708 start
                    //finish();
                //modified by lizusheng@wind-mobi.com 20160708 end
                }
            }
        ...
        //add by lizusheng@wind-mobi.com 20160708 start
        private void deleteAllFingerprint() {
            if (mFingerprintManager != null && mFingerprintManager.isHardwareDetected()
                    && mFingerprintManager.getEnrolledFingerprints().size() > 0) {
                List<Fingerprint> list_fp = mFingerprintManager.getEnrolledFingerprints();
                for (int i = 0; i < list_fp.size(); i++) {
                    mFingerprintManager.remove(list_fp.get(i), mRemovalCallback);
                    Log.d(TAG, "delete fp :" + i);
                }
                    Log.d(TAG, "all fingerprint has removed -- finish");
                    finish();
            }
        }
        //add by lizusheng@wind-mobi.com 20160708 start
        ...
        private boolean setUnlockMethod(String unlockMethod) {
            ...
            if (KEY_UNLOCK_SET_OFF.equals(unlockMethod)) {
               ...
               //liyong01@wind-mobi.com modify for 2016.0818 -s
               /* maybeEnableEncryption(
                        DevicePolicyManager.PASSWORD_QUALITY_ALPHABETIC, false);*/
                maybeEnableEncryption(
                        DevicePolicyManager.PASSWORD_QUALITY_COMPLEX, false);
               //liyong01@wind-mobi.com modify for 2016.0818 -s
              /// M: Add for voice unlock entrance @ {
                ...
                return new AlertDialog.Builder(getActivity())
                        ...
                        .setPositiveButton(R.string.unlock_disable_frp_warning_ok,
                                new DialogInterface.OnClickListener() {
                                    ...
                                    /*lizusheng@wind-mobi.com 20160613 start*/
                                        if (((FingerprintManager) getActivity().getSystemService(Context.FINGERPRINT_SERVICE)).hasEnrolledFingerprints()) {
                                            ((ChooseLockGenericFragment) getParentFragment())
                                                    .deleteAllFingerprint();
                                        }
                                    /*lizusheng@wind-mobi.com 20160613 end*/
                                    }
                                }
                        )
