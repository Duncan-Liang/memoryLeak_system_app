...
public class AsusTelephonyUtils {
    ...
    public static final String VERIZON_CLASS_3_APN_NETWORK_IDENTIFIER = "VZWINTERNET";
    // --- Mark_Huang@20151119: Verizon VZ_REQ_LTEDATA_6742
    ...
    public static boolean isSimLocked(Context context, int slotId) {
        TelephonyManager telephonyManager = (TelephonyManager) context
                .getSystemService(Context.TELEPHONY_SERVICE);
        int simState = telephonyManager.getSimState(slotId);
        Log.v(TAG, "isSimLocked(), slotId =" + slotId + " simState == " + simState);
    ...
    // +++ Mark_Huang@20151119: Verizon VZ_REQ_LTEDATA_6742
    public static boolean isClass3ApnNetworkIdentifier(String apnNetworkIdentifier) {
        return VERIZON_CLASS_3_APN_NETWORK_IDENTIFIER.equals(apnNetworkIdentifier);
    }
    // --- Mark_Huang@20151119: Verizon VZ_REQ_LTEDATA_6742
    /// --- Mark_Huang@20151117: Add for Verizon
