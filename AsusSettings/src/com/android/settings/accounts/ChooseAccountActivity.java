...
//modify by sunxiaolong@wind-mobi.com for removing aucloud and baidupcs begin
import android.os.SystemProperties;
//modify by sunxiaolong@wind-mobi.com for removing aucloud and baidupcs end
...
public class ChooseAccountActivity extends InstrumentedPreferenceActivity {
    ...
    //modify by sunxiaolong@wind-mobi.com for removing aucloud and baidupcs begin
    private static final boolean REMOVE_AUCLOUD_BAIDUCPS = SystemProperties.getBoolean("ro.wind.def.adapt_asus_apk_ww", false);
    //modify by sunxiaolong@wind-mobi.com for removing aucloud and baidupcs end
    ...
    private void onAuthDescriptionsUpdated() {
        ...
        for (int i = 0; i < mAuthDescs.length; i++) {
            ...
            if (addAccountPref) {
                //qiancheng@wind-mobi.com 20160408 not display device&SIM card add start
                //modify by sunxiaolong@wind-mobi.com for removing aucloud and baidupcs start
                if ("com.asus.sim".equals(accountType) || "asus.local.phone".equals(accountType)
                        || (("com.asus.account.aucloud".equals(accountType) || "com.asus.account.baidupcs".equals(accountType))
                        && REMOVE_AUCLOUD_BAIDUCPS)) {

                } else {
                //modify by sunxiaolong@wind-mobi.com for removing aucloud and baidupcs end
                    mProviderList.add(new ProviderEntry(providerName, accountType));
                }
                //qiancheng@wind-mobi.com 20160408 not display device&SIM card add end
            } else {
