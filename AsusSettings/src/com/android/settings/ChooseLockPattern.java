...
public class ChooseLockPattern extends SettingsActivity {
    ...
    public static class ChooseLockPatternFragment extends InstrumentedFragment
        ...
        public void onResume() {
            super.onResume();
            //gaohui@wind-mobi modify 2016/8/12 start to fix Settings fc
            //mLockPatternView.enableInput();
            //gaohui@wind-mobi modify 2016/8/12 end
        }
        ...
        private void saveChosenPatternAndFinish() {
            ...
            final String isFallbackFor = getActivity().getIntent()
            ...
            utils.saveLockPattern(mChosenPattern, mCurrentPattern, isFallback,
                    isFallbackFor, UserHandle.myUserId());
            /// @ }
