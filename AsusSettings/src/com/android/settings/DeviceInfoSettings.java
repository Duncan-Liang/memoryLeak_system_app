...
//lizusheng@wind-mobi.com 20160523 start
//add by mohongwu@wind-mobi.com for Feature#110147 2016/5/10 begin
import android.os.SystemProperties;
import android.preference.CheckBoxPreference;
import android.preference.Preference.OnPreferenceClickListener;
import com.asus.analytics.AnalyticsSettings;
import com.mediatek.settings.FeatureOption;
//add by mohongwu@wind-mobi.com for Feature#110147 2016/5/10 end

//modify by mohongwu@wind-mobi.com for Feature#110147 2016/5/10 begin
//public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable,OnPreferenceClickListener {
//modify by mohongwu@wind-mobi.com for Feature#110147 2016/5/10 end
//lizusheng@wind-mobi.com 20160523 end
    ...
    //add by mohongwu@wind-mobi.com for Feature#110147 2016/5/10 begin
    private final static boolean WIND_DEF_ASUS_ANALYTICS = SystemProperties.get("ro.wind_asus_analytics").equals("1");
    private static final String KEY_ASUS_ANALYTICS = "asus_analytics";
    private static final String KEY_ASUS_INSPIRE = "inspire_asus";
    ...
    public void onCreate(Bundle icicle) {
        ...
        //zhangyanbin@wind-mobi.com 20160620 add start
        if(FeatureOption.WIND_ASUS_FOTA){
            Preference pref = findPreference(KEY_SYSTEM_UPDATE_SETTINGS);	
            if (pref != null) {			
                getPreferenceScreen().removePreference(pref);
            }			
        }		
        //zhangyanbin@wind-mobi.com 20160620 add end
        ...
        if (WIND_DEF_ASUS_ANALYTICS) {
            ...
            boolean isAsusAnalyticsEnable = AnalyticsSettings.getEnableAsusAnalytics(getActivity().getApplicationContext());
            mAsusAnalyticsPreference.setChecked(isAsusAnalyticsEnable);
        } else {
            removePreference(KEY_ASUS_INSPIRE);
        }
        //add by mohongwu@wind-mobi.com for Feature#110147 2016/5/10 end

        // sunxiaolong@wind-mobi.com modify  2016/7/7 begin
        if(!getContext().getResources().getBoolean(R.bool.config_show_regulatory_info)){
            getPreferenceScreen().removePreference(findPreference(KEY_REGULATORY_INFO));
        }
        // sunxiaolong@wind-mobi.com modify  2016/7/7 end
        ...
        getPreferenceScreen().removePreference(findPreference(KEY_BASEBAND_VERSION));
        getPreferenceScreen().removePreference(findPreference("configuration_version"));
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        if (KEY_ASUS_ANALYTICS.equals(key)) {
            boolean isCheck = ((CheckBoxPreference) preference).isChecked();
            Log.v(LOG_TAG, "onPreferenceClick - KEY_ASUS_ANALYTICS : " + isCheck);
            if (!AnalyticsSettings.setEnableAsusAnalytics(getActivity().getApplicationContext(), isCheck)) {
