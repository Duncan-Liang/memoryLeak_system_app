...
public class SimSettings extends RestrictedSettingsFragment implements Indexable,
    ...
    //Add by yinlili@wind-mobi.com 20160612 -s for bug#115508
    private static final boolean WIND_E281L_REMOVE_SMS_ITEM = SystemProperties.get("ro.wind.def.adapt_asus_apk_ww").equals("1");
    //Add by yinlili@wind-mobi.com 20160612 -e for bug#115508
        ...
        if (simPref != null) {
            ...
            if (!shouldDisableActivitesCategory(getActivity())) {
                ...
                if (SystemProperties.get("ro.cmcc_light_cust_support").equals("1")) {
                    if (DBG) log("Op01 open market:set call enable if size >= 1");
                    simPref.setEnabled(allPhoneAccounts.size() >= 1);
                }
                /// M: For Op01 open market. @}
            }
...
//Modify by yinlili@wind-mobi.com 20160612 -s for bug#115508
		//removeSmsItem();
		if (WIND_E281L_REMOVE_SMS_ITEM){
         removeSmsItem();
		}
//Modify by yinlili@wind-mobi.com 20160612 -e for bug#115508
    ...
    private class SimPreference extends RadioPowerPreference{
        ...
        public void update() {
            ...
            if (mSubInfoRecord != null) {
                ...
                //M: huangyouzhong@wind-mobi.com 20160816 for 127644 -s
                if (AsusTelephonyUtils.isSimLocked(mContext, getSlotId())) {
                    Log.d(TAG, "update, setRadioOn false");
                    setRadioOn(false);
                } else {
                    setRadioOn(TelephonyUtils.isRadioOn(mSubInfoRecord.getSubscriptionId(),
                            getContext()));
                }
                //M: huangyouzhong@wind-mobi.com 20160816 for 127644 -e
                /// @}
            } else {
