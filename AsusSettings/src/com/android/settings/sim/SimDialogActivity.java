...
//liuyang@wind-mobi.com add for bug#127130 2016/08/15 begin
import com.mediatek.telephony.TelephonyManagerEx;
//liuyang@wind-mobi.com add for bug#127130 2016/08/15 end

import java.util.ArrayList;
import java.util.Iterator;
import java.util.List;

//add by youxiaoyan@wind-mobi.com for Bug#111964 2016/6/2 start
import android.os.SystemProperties;
//add by youxiaoyan@wind-mobi.com for Bug#111964 2016/6/2 end
...
public class SimDialogActivity extends Activity {
    ...
    // pengfugen@wind-mobi.com 2016/06/06 start
    private static final boolean WIND_DEF_OPTR_E280L_CMCC = SystemProperties.get("ro.wind.def.optr.e280l.cmcc").equals("1");
    private static final boolean WIND_DEF_OPTR_E280L_CMCCCLB = SystemProperties.get("ro.wind.def.optr.e280l.cmccclb").equals("1");
    // pengfugen@wind-mobi.com 2016/06/06 end
    ...
    private void setDefaultDataSubId(final Context context, final int subId) {
        ...
        if (FeatureOption.MTK_CT6M_SUPPORT || true) {
        // pengfugen@wind-mobi.com 2016/06/06 end
        ...
        //add by youxiaoyan@wind-mobi.com for Bug#111964 2016/6/2 start
        SystemProperties.set("persist.asus.mobile_slot", String.valueOf(subscriptionManager.getSlotId(subId)));
        //add by youxiaoyan@wind-mobi.com for Bug#111964 2016/6/2 end
        /// M: for plug-in @{
        // Toast.makeText(context, R.string.data_switch_started, Toast.LENGTH_LONG).show();

        //liuyang@wind-mobi.com modify for bug#127130 2016/08/15 begin
        /*Toast.makeText(
                context,
        ...
        int sim1State = telephonyManagerEx.getSimState(SIM_CARD_SLOT_1);
        int sim2State = telephonyManagerEx.getSimState(SIM_CARD_SLOT_2);
        ...
        //liuyang@wind-mobi.com modify for bug#127130 2016/08/15 end
        /// @}
    }
