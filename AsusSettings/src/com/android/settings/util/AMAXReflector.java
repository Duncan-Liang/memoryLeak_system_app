...
public final class AMAXReflector {
     ...
     * @return 1. null: void method or no such method.<BR>2. the return value from Feature Method as
     * type T.
...
//        Log.v(AMAXReflector.class.getName(), result.toString());
    ...
    // +++ Beyond_Chao, wallpaper settings
    public static boolean isSupportIntent(String fieldName, boolean defaultValue) {
