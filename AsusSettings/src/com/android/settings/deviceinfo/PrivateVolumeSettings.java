...
// sunhuihui@wind-mobi.com modify begin 2016/6/1
import android.os.SystemProperties;
// sunhuihui@wind-mobi.com modify end 2016/6/1
...
// xuyi@wind-mobi.com 20160531 add for bug#109977 begin
import android.content.ComponentName;
// xuyi@wind-mobi.com 20160531 add for bug#109977 end

/**
 * Panel showing summary and actions for a {@link VolumeInfo#TYPE_PRIVATE}
 * storage volume.
 * modify by sunxiaolong@wind-mobi.com for asus's storage showing
 *
 */
public class PrivateVolumeSettings extends SettingsPreferenceFragment {
    ...
    public static final boolean WIND_DEF_MUSIC_ASUS = SystemProperties.get("ro.wind.def.music.asus").equals("1");
    public static final boolean WIND_DEF_MUSIC_GMS = SystemProperties.get("ro.wind.def.music.gms").equals("1");
    ...
    public void update() {
        ...
        // sunhuihui@wind-mobi.com modify begin 2016/6/1
        final long totalBytes = file.getTotalSpace(); // total of /data
        final long freeBytes = file.getFreeSpace(); // free of data
        final long usedBytes = totalBytes - freeBytes; // used by data

        if (WIND_DEF_ASUS_STORAGE) {
            CharSequence title = Formatter.formatFileSize(context, freeBytes) + " " + getString(R.string.memory_available);
            String summary = getString(R.string.storage_volume_summary,
                    Formatter.formatFileSize(context, usedBytes), Formatter.formatFileSize(context, totalBytes));
            mSummary.setTitle(title);
    ...
    private final boolean WIND_DEF_ASUS_STORAGE =  SystemProperties.getInt("ro.wind.def.asus_storage", 0) == 1;
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference pref) {
        ...
        switch (itemTitleId) {
            ...
            // xuyi@wind-mobi.com 20160629 modify for bug#109977 begin
            /*
            ...
            */
            ...
            case R.string.storage_detail_videos: {
                ...
                ComponentName cn = new ComponentName("com.asus.gallery", "com.asus.gallery.app.EPhotoActivity");
            ...
            */
            case R.string.storage_detail_audio: {
                ...
                intent.addCategory(Intent.CATEGORY_LAUNCHER);
                ComponentName cn;
                if (WIND_DEF_MUSIC_ASUS) {
                    cn = new ComponentName("com.asus.music", "com.asus.music.MusicMainActivity");
                } else if (WIND_DEF_MUSIC_GMS) {
                    cn = new ComponentName("com.google.android.music", "com.android.music.activitymanagement.TopLevelActivity");
                } else {
                    intent = new Intent(DocumentsContract.ACTION_BROWSE_DOCUMENT_ROOT);
                    intent.setData(DocumentsContract.buildRootUri(AUTHORITY_MEDIA, "audio_root"));
                    intent.addCategory(Intent.CATEGORY_DEFAULT);
            ...
            // xuyi@wind-mobi.com 20160629 modify for bug#109977 end
