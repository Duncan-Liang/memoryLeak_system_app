...
public class ImeiInformation extends InstrumentedPreferenceActivity {
    ...
    private void initPreferenceScreen(int slotCount) {
        ...
        for (int slotId = 0; slotId < slotCount; slotId ++) {
            ...
            setNewKey(slotId);
            /// M: for plug-in
            UtilsExt.getStatusExtPlugin(this).customizeImei(
                    "_" + KEY_IMEI + String.valueOf(slotId),
                    "_" + KEY_IMEI_SV + String.valueOf(slotId), getPreferenceScreen(), slotId);
        }
    }
        ...
        if (phone != null) {
            if (phone.getPhoneType() == TelephonyManager.PHONE_TYPE_CDMA) {
                ...
                if (phone.getLteOnCdmaMode() == PhoneConstants.LTE_ON_CDMA_TRUE) {
                    ...
                    setSummaryText(KEY_IMEI, AsusTelephonyUtils.formatIdentityDisplay(phone.getImei()));
...
//lizusheng@wind-mobi.com 20160523 start
    ...
    protected void onResume() {
        ...
        try {
            ...
            tabLV = (android.widget.ListView) findViewById(resId);
