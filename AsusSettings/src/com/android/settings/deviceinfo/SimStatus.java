...
//lizusheng@wind-mobi.com 20160523 start
        ...
        try {
            ...
            tabLV = (ListView) findViewById(resId);
...
//lizusheng@wind-mobi.com 20160523 end
    ...
    private OnTabChangeListener mTabListener = new OnTabChangeListener() {
        ...
        public void onTabChanged(String tabId) {
            ...
            //modify by sunxiaolong@wind-mobi.com for #110633 start
            if(mSelectableSubInfos.size() > 0) {
            mSir = mSelectableSubInfos.get(slotId);
            /// M: for [C2K SIM Status]
            mCdmaSimStatus.setSubscriptionInfo(mSir);
            }
            //modify by sunxiaolong@wind-mobi.com for #110633 end
            ...
            updateDataState();
            updateNetworkType();
            //zhangtao@wind-mobi.com 2016/8/2 add begain
            if (mPhone != null) {
                updateSignalStrength(mPhone.getSignalStrength());
                updateServiceState(mPhone.getServiceState());
            }
            //zhangtao@wind-mobi.com 2016/8/2 add end
            updatePreference();
        }
    };
