 ...
 *
 * modify by sunxiaolong@wind-mobi.com for asus owner info from original AsusSettings
 *
 */
...
public class OwnerInfoSettings extends Fragment {
    ...
    private void initView() {
        ...
        final boolean enabled = mLockPatternUtils.isOwnerInfoEnabled(UserHandle.USER_OWNER);
        ...
        mCheckbox.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                mLockPatternUtils.setOwnerInfoEnabled(isChecked,UserHandle.USER_OWNER);
