...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    // Preferences
    private static final String TOGGLE_EXTRA_LARGE_TEXT_PREFERENCE =
            "toggle_extra_large_text_preference";
    ...
    private void handleToggleLargeTextPreferenceClick() {
        ...
        if (FeatureOption.MTK_PRODUCT_IS_TABLET) {
            ...
            if (array.length > 0) {
                mLargeFontScaleTablet = Float.parseFloat(array[array.length - 1]);
            }
            fontScale = mLargeFontScaleTablet;
        } else if (mToggleLargeTextPreference.isChecked()) {
    ...
    private void initializeAllPreferences() {
        ...
        mToggleLargeTextPreference =
                (SwitchPreference) findPreference(TOGGLE_EXTRA_LARGE_TEXT_PREFERENCE);
    ...
    private void updateSystemPreferences() {
        ...
        /** M: MTK fix fonts problem @{ */
        float updateFontScale = LARGE_FONT_SCALE ;
        if (FeatureOption.MTK_PRODUCT_IS_TABLET) {
            String[] array = getResources().getStringArray(R.array.entryvalues_font_size);
            if (array.length > 0) {
                mLargeFontScaleTablet = Float.parseFloat(array[array.length - 1]);
