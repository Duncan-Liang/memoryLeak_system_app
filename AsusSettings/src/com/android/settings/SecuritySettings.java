...
// youxiaoyan@wind-mobi.com 2016/6/21 begin
import android.os.SystemProperties;
// youxiaoyan@wind-mobi.com 2016/6/21 end
...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    private PreferenceScreen createPreferenceHierarchy() {
		...
		//D: huangyouzhong@wind-mobi.com 20160525 -s : Asus LockScreen Settings
        //final int resid = getResIdForLockUnlockScreen(getActivity(), mLockPatternUtils);
        //addPreferencesFromResource(resid);
        //D: huangyouzhong@wind-mobi.com 20160525 -e : Asus LockScreen Settings
        ...
        if (mOwnerInfoPref != null) {
            mOwnerInfoPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    //delete by sunxiaolong@wind-mobi.com for adding owner info start
                    //OwnerInfoSettings.show(SecuritySettings.this);
                    //delete by sunxiaolong@wind-mobi.com for adding owner info end
                    return true;
                }
            });
        }
        ...
        if (securityCategory != null) {
            ...
            //delete by sunxiaolong@wind-mobi.com for smart lock pos start
            //addTrustAgentSettings(securityCategory);
            //delete by sunxiaolong@wind-mobi.com for smart lock pos end
        }
    ...
    private void addPluginEntrance(PreferenceGroup deviceAdminCategory) {
        ...
        if (!SystemProperties.get("ro.wind.def.asussettings").equals("1")) {
            mDataProectExt.addDataPrf(deviceAdminCategory);
        }
        // youxiaoyan@wind-mobi.com  2016/6/21 end
